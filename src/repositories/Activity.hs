...
module Activity(insertActivity, findActivity, findActivityAll, lastActivityQuery, toActivityDTO, getContentType) where
...
data Activity f = Activity
    {actContent :: Column f ActivityContent
...
getContentType :: Activity Result -> ActivityContent
getContentType p = p.actContent
